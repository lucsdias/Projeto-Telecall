                    ...
                    <div class="card text-bg-primary  mt-5" style="max-width: 500px;">
                        <a class="" style="text-decoration:none; color:white;  " href="tabUsuario.php">
                            <div class="card-body" style="background-color: #00497a;">
                                <h5 class=""> DADOS PESSOAIS <div class="col-auto"><i class="d-flex fas fa-user-astronaut fa-2x text-gray-300 justify-content-between"> </i></div>
                                </h5>
                ...
                <div class="col-xl-6 col-md-6 mb-0">
                    <div class="card text-bg-primary  mt-5" style="max-width: 500px;">
                        <a class="" style="text-decoration:none; color:white;  " href="endUsuario.php">
                            <div class="card-body" style="background-color: #00497a;">
                                <h5 class=" "> ENDEREÇO <div class="col-auto"><i class="d-flex fas fa-map fa-2x text-gray-300 justify-content-between"> </i></div>
                                </h5>
        ...
        <div class="container ">
            <table class="table table-striped mt-5">
                ...
                <tbody>
                    ...
                    <td><?php echo $_SESSION['complemento'] ?></td>
                    <td><?php echo $_SESSION['cidade'] ?></td>
                    <td align="center"><?php echo $_SESSION['uf'] ?></td>
                </tbody>
            </table>
        </div>
